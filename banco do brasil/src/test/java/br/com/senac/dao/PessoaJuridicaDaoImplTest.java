...
public class PessoaJuridicaDaoImplTest {
    ...
    public void testSalvar(){
        ...
        //(String cnpj, String inscricaoEstadual, String nome, String email)
        pessoaJuridica = new PessoaJuridica (gerarCnpj(), gerarNumero(6), "Empresa " + gerarNome(), gerarLogin() + "gamil.com");
